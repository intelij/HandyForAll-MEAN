...
module.exports = function (io) {
  ...
  */
  ...
  router.saveCurrentLocation = function (req, res) {
    console.log("req", req.body);
    db.UpdateDocument('tasker', { '_id': req.body.data }, { 'location.lan': req.body.location.lat, 'location.lat': req.body.location.lat }, {}, function (err, docdata) {
      if (err) {
        res.send(err);
      } else {
        res.send(docdata);
