  ...
  tfc.confirmatask = function confirmatask(message) {
    ...
    modalInstance.result.then(function (bDeliverAtProviderLocation) {
      ...
      if (bDeliverAtProviderLocation) {
        tfc.taskinfo.location = message.tasker.location;
        tfc.taskinfo.task_address = message.tasker.address || {};
        tfc.taskinfo.task_address.lat = tfc.taskinfo.location.lat;
        tfc.taskinfo.task_address.lng = tfc.taskinfo.location.lng;
      }
      ...
      if (tfc.filter.time) {
        ...
        TaskService.confirmtask(tfc.taskinfo, date).then(function (result) {
          console.log("confirm task result", result);
